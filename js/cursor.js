...
(function () {
    ...
    function addCursorToElement(element) {
      ...
      if (!document.hasFocus()) hideCursor();
    ...
    */
    ...
    window.cursorContainer = byId('search-box');
